...
public final class PercentDomExtender extends DomExtender<AndroidDomElement>{
    ...
    public void registerExtensions(@Nonnull AndroidDomElement element,@Nonnull final DomExtensionsRegistrar registrar){
        ...
        try{
            PercentAttrProcessing.registerPercentAttributes(facet,element,callback);
    ...
    public static void install(){
        ...
        String clazzName=PercentDomExtender.class.getCanonicalName();
        ...
        if(androidDomExtenderEp!=null){
            ...
            ep.extenderClassName=PercentDomExtender.class.getCanonicalName();
            try{
                Field field=ep.getClass().getDeclaredField("myExtender");
                field.setAccessible(true);
                field.set(ep,new PercentDomExtender());
